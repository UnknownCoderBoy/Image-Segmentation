...
st.title("Image Segmentation Techniques")
...
if selectbox == "Using Color Masking":
...
if selectbox == "Using Otsu Thresholding":
  st.subheader(selectbox)
...
if selectbox == "Using Morphological Operations":
  st.subheader(selectbox)
...
if selectbox == "Using Grabcut Algorithm":
  st.subheader(selectbox)
  ...
  if image_file is not None:
    ...
    cv2.rectangle(imagecopy, (ix, iy), (w, h), color, thickness=2)
